...
4. Wybierz utworzoną App Registration (`dvlp-ksef-api`)
...
2. Wybierz aplikację dla Web App (np. `dvlp-ksef-web` lub użyj tej samej `dvlp-ksef-api`)
...
|----------|----------|-----------|------|
| `-AppName` | ❌ | `dvlp-ksef-api` | Nazwa App Registration |
