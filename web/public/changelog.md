...
- **Pełna szerokość widoku** — strona szczegółów samofaktury (`/self-billing/[id]`) nie jest już ograniczona do `max-w-4xl`; układ dopasowano do widoków faktur i dokumentów kosztowych
