...
2. → [Konfiguracja Entra ID](./ENTRA_ID_KONFIGURACJA.md) (jeśli nie wykonano)
...
- [Konfiguracja Entra ID](./ENTRA_ID_KONFIGURACJA.md) — App Registration, grupy
- [Wdrożenie API](./API_DEPLOYMENT.md) — deploy Azure Functions
- [Wdrożenie Web](./WEB_DEPLOYMENT.md) — deploy App Service
