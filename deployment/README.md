...
1. [Architektura docelowa](#architektura-docelowa)
2. [Struktura katalogu deployment/](#struktura-katalogu-deployment)
3. [Dane do zebrania przed startem](#dane-do-zebrania-przed-startem)
4. [Uruchomienie lokalne (opcjonalne)](#uruchomienie-lokalne-opcjonalne)
5. [Krok 0 — Przygotowanie środowiska](#krok-0--przygotowanie-środowiska)
6. [Krok 1 — Weryfikacja narzędzi i dostępów](#krok-1--weryfikacja-narzędzi-i-dostępów)
7. [Krok 2 — Import solucji Power Platform](#krok-2--import-solucji-power-platform)
8. [Krok 3 — Entra ID: App Registration](#krok-3--entra-id-app-registration)
9. [Krok 4 — Application User w Dataverse](#krok-4--application-user-w-dataverse)
10. [Krok 5 — Infrastruktura Azure](#krok-5--infrastruktura-azure)
11. [Krok 6 — Zmienne środowiskowe (Function App)](#krok-6--zmienne-środowiskowe-function-app)
12. [Krok 7 — Deploy API (Azure Functions)](#krok-7--deploy-api-azure-functions)
13. [Krok 8 — Deploy Web (App Service)](#krok-8--deploy-web-app-service)
14. [Krok 8a — Redirect URI w Entra ID](#krok-8a--redirect-uri-w-entra-id)
15. [Krok 9 — AI Categorization (Azure OpenAI)](#krok-9--ai-categorization-azure-openai)
16. [Krok 10 — Custom Connector](#krok-10--custom-connector)
17. [Krok 11 — Connection References i Power Automate](#krok-11--connection-references-i-power-automate)
18. [Krok 12 — Tokeny KSeF](#krok-12--tokeny-ksef)
19. [Krok 13 — Role i uprawnienia](#krok-13--role-i-uprawnienia)
20. [Krok 14 — Weryfikacja końcowa](#krok-14--weryfikacja-końcowa)
21. [Krok 15 — Po wdrożeniu](#krok-15--po-wdrożeniu)
22. [Rozwiązywanie problemów](#rozwiązywanie-problemów)
...
**Cel:** Upewnić się, że masz wszystkie narzędzia, rozszerzenia VS Code, uprawnienia i wiedzę o konfiguracjach specyficznych dla klienta.
...
> **⚠️ Role Dataverse:** Rola **System Administrator** jest wymagana do importu solucji i tworzenia Application User.
> Rola **System Customizer** jest wystarczająca do dalszej konfiguracji, ale nie pozwoli na tworzenie Application Users.
> Upewnij się, że osoba wdrażająca ma odpowiednią rolę PRZED rozpoczęciem kroku 2 (import solucji).
...
**Cel:** Zweryfikować, że wszystkie narzędzia z kroku 0 są zainstalowane i masz wymagane uprawnienia.
...
## Krok 2 — Import solucji Power Platform
...
## Krok 3 — Entra ID: App Registration
...
## Krok 4 — Application User w Dataverse
...
> Alternatywnie: `westeurope` lub `northeurope`.
...
## Krok 6 — Zmienne środowiskowe (Function App)
...
## Krok 7 — Deploy API (Azure Functions)
...
## Krok 8a — Redirect URI w Entra ID
...
## Krok 9 — AI Categorization (Azure OpenAI)
...
## Krok 11 — Connection References i Power Automate
...
*Wersja 3.0 — 2025-06-14 — 16 kroków (0-15 + 8a), dodano: Step 0, AI Categorization, Redirect URI, Post-deployment, manual Portal guide, MPK documentation.*
