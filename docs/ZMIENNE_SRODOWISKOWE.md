...
- [Zmienne środowiskowe — Kompletna referencja](#zmienne-środowiskowe--kompletna-referencja)
  ...
  - [Produkcja — Azure App Settings](#produkcja--azure-app-settings)
    - [Azure Functions (`dvlp-ksef-func`)](#azure-functions-dvlp-ksef-func)
...
| `API_URL` | ✅ (prod) | `https://dvlp-ksef-func-...azurewebsites.net` | URL API dla rewrites (server-side) |
...
### Azure Functions (`dvlp-ksef-func`)
