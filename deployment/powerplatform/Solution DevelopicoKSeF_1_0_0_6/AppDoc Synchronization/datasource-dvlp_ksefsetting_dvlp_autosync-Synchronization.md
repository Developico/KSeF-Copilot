...
### dvlp\_ksefsetting\_dvlp\_autosync

| Property | Value                             |
| -------- | --------------------------------- |
| Name     | dvlp\_ksefsetting\_dvlp\_autosync |
| Type     | OptionSetInfo                     |
...
| DisplayName                | Auto Sync (KSeF Settings)                                                                                                                          |
...
| OptionSetReference         | "OptionSetReferenceItem0": {"OptionSetReferenceEntityName": "KSeF Settings", "OptionSetReferenceColumnName": "dvlp\_autosync"}                     |
| OptionSetTypeKey           | BooleanType                                                                                                                                        |
| RelatedColumnInvariantName | dvlp\_autosync                                                                                                                                     |
