...
### dvlp\_ksefinvoice\_statuscode

| Property | Value                         |
| -------- | ----------------------------- |
| Name     | dvlp\_ksefinvoice\_statuscode |
| Type     | OptionSetInfo                 |
...
| DisplayName                | Status Reason (KSeF Invoices)                                                                                                                               |
...
| OptionSetReference         | "OptionSetReferenceItem0": {"OptionSetReferenceEntityName": "KSeF Invoices", "OptionSetReferenceColumnName": "statuscode"}                                  |
