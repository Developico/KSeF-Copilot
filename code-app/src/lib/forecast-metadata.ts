 ...
 *
 * These mirror the backend definitions in api/src/lib/forecast/engine.ts
 * and api/src/lib/forecast/anomalies.ts. Used as fallback data when the
 * metadata API endpoints are not yet deployed or unavailable.
 */
