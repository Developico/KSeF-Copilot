...
interface CostNotesSectionProps {
...
export function CostNotesSection({
  ...
  const {
    ...
    queryKey: ['cost-documents', costDocumentId, 'notes'],
    queryFn: () => api.costDocuments.listNotes(costDocumentId),
    enabled: isExpanded,
  })

  const createNoteMutation = useMutation({
    mutationFn: (data: NoteCreate) => api.costDocuments.createNote(costDocumentId, data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['cost-documents', costDocumentId, 'notes'] })
      toast({
