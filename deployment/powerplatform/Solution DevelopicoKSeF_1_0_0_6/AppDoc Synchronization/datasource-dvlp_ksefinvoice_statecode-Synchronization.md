...
### dvlp\_ksefinvoice\_statecode

| Property | Value                        |
| -------- | ---------------------------- |
| Name     | dvlp\_ksefinvoice\_statecode |
| Type     | OptionSetInfo                |
...
| DisplayName                | Status (KSeF Invoices)                                                                                                                                      |
...
| OptionSetReference         | "OptionSetReferenceItem0": {"OptionSetReferenceEntityName": "KSeF Invoices", "OptionSetReferenceColumnName": "statecode"}                                   |
